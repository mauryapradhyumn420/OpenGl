...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		switch (wParam)
		{
			...
			case 0x30:
			case VK_NUMPAD0:
				MessageBox(hwnd,TEXT("0 is not Set Yet.Start With 1-9."),TEXT("info"),MB_ICONINFORMATION);
				//glViewport((GLsizei)WIN_WIDTH / 2, 0, (GLsizei)WIN_WIDTH / 2, (GLsizei)WIN_HEIGHT / 2);
				break;
...
void Resize(int iWidth, int iHeight,int cx,int cy)
{
	if (iHeight == 0)
		iHeight = 1;

	glViewport((GLsizei)cx ,(GLsizei)cy, (GLsizei)iWidth, (GLsizei)iHeight);
}
